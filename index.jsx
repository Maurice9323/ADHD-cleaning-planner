...
<head>
  ...
  <title>ADHD Cleaning Planner</title>
  <!-- Google Fonts -->
...
<body>
  ...
  <script type="text/babel" data-presets="react">
    ...
    // ── Main Component ────────────────────────────────────────────────────────
    function ADHDCleaningPlanner() {
      const [nav, setNav]           = React.useState("dashboard");
      const [selDay, setSelDay]     = React.useState(DOW);
      const [selWeek, setSelWeek]   = React.useState(WEEKNUM);
      const [selMonth, setSelMonth] = React.useState(MONTH);
      const [selSeason, setSelSeason] = React.useState(SEASON);
      const [dashTab, setDashTab]   = React.useState("today");
    ...
    ReactDOM.createRoot(document.getElementById("root")).render(<ADHDCleaningPlanner />);
  </script>
</body>
</html>